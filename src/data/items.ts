...
export const SHOP_ITEMS: ShopItemDef[] = [
  ...
  {
    id: 'buzzlightyear-wristband',
    name: "Buzz's Wrist Communicator",
    icon: '🚀',
    price: 235,
    kind: 'equipment',
    tier: 'epic',
    boosts: { spd: 0.09, def: 0.07, energyGain: 0.09 },
    affinity: {
      franchises: ['disney'],
      multiplier: 1.5,
      description: 'Disney legends go to infinity and beyond, learning Wrist Laser.',
      ability: skill({
        id: 'item-buzz-wristband',
        name: 'Wrist Laser',
        cooldown: 9,
        effects: [
          { kind: 'damage', target: 'enemy-lowest', mult: 1.7 },
          { kind: 'buff', target: 'self', stat: 'spd', amount: 0.15, duration: 4 },
        ],
        fx: 'beam',
        color: 0x9be8ff,
      }),
    },
    description: '+9% SPD, +7% DEF and +9% energy gain while held.',
    minFloor: 3,
  },
  {
    id: 'zoros-katana',
    name: "Zoro's Wado Ichimonji",
    icon: '🗡️',
    price: 380,
    kind: 'equipment',
    tier: 'legendary',
    boosts: { atk: 0.16, crit: 0.08 },
    affinity: {
      franchises: ['anime'],
      multiplier: 1.75,
      description: 'Anime warriors master the blade and learn Three-Sword Style.',
      ability: skill({
        id: 'item-zoros-katana',
        name: 'Three-Sword Style',
        cooldown: 10,
        effects: [
          { kind: 'damage', target: 'enemy-front', mult: 1.2, hits: 2 },
          { kind: 'debuff', target: 'enemy-front', stat: 'def', amount: 0.12, duration: 4 },
        ],
        fx: 'strike',
        color: 0x8de8a8,
      }),
    },
    description: '+16% ATK and +8% crit while held.',
    minFloor: 6,
  },
  {
    id: 'yodas-lighsaber',
    ...
    kind: 'equipment',
    tier: 'legendary',
    boosts: { atk: 0.14, spd: 0.10 },
    affinity: {
      franchises: ['star-wars'],
      multiplier: 1.5,
      description: 'Star Wars legends channel the Force and learn Ataru Flurry.',
      ability: skill({
        id: 'item-yodas-lightsaber',
        name: 'Ataru Flurry',
        cooldown: 10,
        effects: [
          { kind: 'damage', target: 'enemy-random', mult: 0.7, hits: 3 },
          { kind: 'buff', target: 'self', stat: 'crit', amount: 0.12, duration: 4 },
        ],
        fx: 'burst',
        color: 0x7dff62,
      }),
    },
    description: '+14% ATK and +10% SPD while held.',
    minFloor: 6,
  },
  {
    id: 'chaos-emerald',
